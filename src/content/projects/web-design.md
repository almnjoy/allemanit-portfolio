...
The work has spanned a lot of ground: client portals with role-based dashboards, a payment portal wired to Stripe and Plaid, deployable lead-capture and intake landing pages, a study companion for the Cisco CCDE, documentation hubs, and full marketing sites. Different audiences, different stacks, the same goal each time.
